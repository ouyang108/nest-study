...
const error_exception_filter_1 = require("../../exception/error-exception.filter");
...
__decorate([
    (0, cache_manager_1.CacheKey)('cats'),
...
__decorate([
    (0, cache_manager_1.CacheKey)('catId'),
    (0, cache_manager_1.CacheTTL)(60 * 1000),
    (0, common_1.Get)(':id'),
...
exports.CatsController = CatsController = __decorate([
    (0, common_1.UseFilters)(error_exception_filter_1.localErrorFilter),
    (0, common_1.UseInterceptors)(exception_filter_1.LocalExceptionFilter),
